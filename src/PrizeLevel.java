...
/**
 * The PrizeMoney enum represents different prize levels in a quiz game,
 * each associated with a specific monetary amount.
 * Levels range from LEVEL_0 (no prize) to LEVEL_15 (top prize).
 * Each level corresponds to a question in the game.
 *
